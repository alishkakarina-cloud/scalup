...
export function StoPage() {
  ...
  return (
    <div>
      <section className="relative overflow-hidden bg-ink-950 border-b border-white/10">
        <div
        ...
        <div className="relative mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 py-12">
          <div className="flex flex-col sm:flex-row items-start gap-6">
            <span className="flex h-20 w-20 shrink-0 items-center justify-center rounded-2xl border border-white/10 text-lime-500">
      ...
      <section className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 py-10 grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div className="rounded-2xl border border-white/10 bg-ink-900 p-5 flex items-start gap-3">
      ...
      <section id="services" className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 py-6 scroll-mt-20">
        ...
        <div className="mt-4 divide-y divide-white/10 rounded-2xl border border-white/10 bg-ink-900">
      ...
      <section className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 py-6 pb-14">
        ...
        <div className="mt-4 grid grid-cols-1 sm:grid-cols-3 gap-4">
          {sto.reviews.map((review) => (
            <div key={review.id} className="rounded-2xl border border-white/10 bg-ink-900 p-4">
        ...
        <div className="mt-10 flex items-center justify-between gap-4 rounded-2xl border border-white/10 bg-ink-900 px-6 py-5">
