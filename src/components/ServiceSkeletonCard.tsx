...
export function ServiceSkeletonCard() {
  return (
    <div className="flex flex-col rounded-2xl border border-dashed border-paper/15 bg-paper/[0.02] p-4">
      <div className="flex h-32 w-full items-center justify-center rounded-xl bg-paper/[0.03] text-paper/20">
      ...
      <div className="mt-4 flex gap-2">
        <button
          disabled
          className="flex-1 inline-flex items-center justify-center gap-1.5 rounded-xl bg-paper/10 py-2 text-sm font-bold text-paper/25 cursor-not-allowed"
        >
          <CalendarCheck size={14} strokeWidth={1.5} /> Записаться
        </button>
        <button
          disabled
          className="flex h-9 w-9 items-center justify-center rounded-full border border-paper/10 text-paper/20 cursor-not-allowed"
